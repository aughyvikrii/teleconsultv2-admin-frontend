...
const Finance = (props) => {
            ...
            return result.push({
                ...
                mobile_data: (<>
                    <Cards border={true} headless={true} className="text-left">
                        ...
                        <b>Status</b> <br/>
                        {payment_label(row.status)} <br/> <br/>

                        <div className="table-actions">
                        <>
                            <Button className="btn-icon" size="small" block={true} type="primary" title="Detail" onClick={() =>  history.push(`/admin/bill/${row.bill_uniq}`) }>
                ...
                action:(
                    <div className="table-actions">
                        <>
                            <Link to={`/admin/bill/${row.bill_uniq}`}>
                                <Button className="btn-icon" size="default" shape="round" type="primary" title="Detail">
    ...
    const columns = [
        ...
        { title: 'Aksi', dataIndex: 'action', key: 'action', responsive: ['sm'] },
    ];
